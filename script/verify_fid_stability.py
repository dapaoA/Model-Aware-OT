...
def main():
    ...
    for model_key, model_info in models.items():
        ...
        output_dir = Path(f"exp/fid_results/{model_key}_iter_10000_steps5_50k_images")
    ...
    # 保存结果
    results_file = Path("exp/fid_stability_verification_50k_images.json")
    ...
    # 读取之前的结果
    previous_file = Path("exp/fid_training_curves_results_steps5.json")
    if previous_file.exists():
        ...
        # 读取10000张图片的结果
        results_10k_file = Path("exp/fid_stability_verification_10k_images.json")
        results_10k = {}
