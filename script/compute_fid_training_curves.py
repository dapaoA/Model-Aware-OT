...
def main():
    ...
    for model_key, model_info in models.items():
        ...
        for iter_num in iterations:
            ...
            output_dir = Path(f"exp/fid_results/{model_key}_iter_{iter_num}")
    ...
    # 保存结果到JSON文件
    results_file = Path("exp/fid_training_curves_results.json")
    ...
    # 保存图片
    plot_file = Path("exp/fid_training_curves.png")
